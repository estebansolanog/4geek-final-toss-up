...
export const PublicNavbar = () => {
  ...
  return (
    ...
    //             <button className="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-egg-fried" viewBox="0 0 16 16">
    ...
    // </nav>
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg bg-grey">
