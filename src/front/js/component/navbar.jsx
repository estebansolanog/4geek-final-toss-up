    ...
    <>
      ...
      <nav className="navbar private-navbar navbar-expand-md d-none d-xs-block d-sm-block d-md-block">
        <div className="container-fluid">
          ...
          {store.userLogin ?
            <button className="btn btn-danger" onClick={(e) => { handleLogout() }}>Logout</button>
      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary bg bg-black d-xs-none d-sm-none d-md-none">
        <div className="container-fluid">
          ...
          <form className="d-flex" role="search">
            <input className="form-control me-2" type="search" placeholder="Que quieres preparar hoy?" aria-label="Search" />
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                {store.userLogin ?
                  <span className="text-danger" onClick={(e) => { handleLogout() }}>Logout</span>
