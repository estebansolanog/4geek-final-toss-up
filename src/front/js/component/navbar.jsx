...
export const Navbar = () => {
  ...
  const handleLogout = () => {
    // Suponemos que actions.logout retorna una promesa que se resuelve cuando el logout es exitoso.
    actions.logout()
      .then(() => {
        // Borra el estado de inicio de sesión en localStorage solo si el cierre de sesión es exitoso.
        localStorage.removeItem('userLogin');
      })
      .catch((error) => {
        // Maneja cualquier error que ocurra durante el cierre de sesión aquí.
        console.log(error);
      });
