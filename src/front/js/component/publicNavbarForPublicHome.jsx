      ...
      <>
        <nav className="navbar private-navbar navbar-expand-md d-none d-xs-block d-sm-block d-md-block">
          <div className="container-fluid">
            ...
            <button className="btn btn-danger" onClick={(e) => { handleLogout() }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
